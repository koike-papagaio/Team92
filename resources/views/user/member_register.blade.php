    ...
    <div class="member_register-container w-50" style="margin: auto;">
        ...
        <form action="{{ url('member_register') }}" method="POST">
            ...
            <div class="form-group ">
                ...
                <input type="text" name="name" class="form-control" id="user-name" placeholder="お名前を入力してください" maxlength="30" required autofocus>
            </div>

            <div class="form-group">
                <label for="user-address" class="form-label">住所</label>
                <input type="text" name="address" class="form-control" id="user-address" placeholder="住所を入力してください" maxlength="191" required>
            </div>

            <div class="form-group">
                <label for="user-email" class="form-label">メールアドレス</label>
                <input type="email" name="email" class="form-control" id="user-email" placeholder="メールアドレスを入力してください" maxlength="191" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="pay_limit" class="form-control" id="user-pay_limit" placeholder="使用限度額を入力してください" required>
            </div>
